...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const onChat = async () => {
      ...
      const response = await fetch(location.protocol + "//" + location.host + "/portal/ai/chat", {
        method: "POST",
        headers: {
    ...
    const processLine = (line) => {
      var _a;
      const jsonData = JSON.parse(JSON.parse(line));
      if (jsonData.extend === "END") {
        routing.setIsLoad(false);
      }
      chatList.value[chatList.value.length - 1].chatType = (_a = jsonData == null ? void 0 : jsonData.type) != null ? _a : "CHAT";
      chatList.value[chatList.value.length - 1].content += jsonData.content;
      rollBottom();
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "preview" }, _attrs))} data-v-c4535ae6><div class="preview-top" data-v-c4535ae6>${ssrInterpolate(styleSetup.value.name)}</div><div class="preview-content" data-v-c4535ae6><div class="preview-content-main" data-v-c4535ae6><!--[-->`);
      ssrRenderList(chatList.value, (item, index) => {
        _push(`<div class="${ssrRenderClass([item.type == "SYSTEM" ? "left" : "right", "content"])}" data-v-c4535ae6><div class="logo" data-v-c4535ae6>`);
        if (item.type == "SYSTEM") {
          _push(`<!--[-->`);
          if (styleSetup.value.robotLogo) {
            _push(`<img${ssrRenderAttr("src", styleSetup.value.robotLogo)} data-v-c4535ae6>`);
          } else {
            _push(`<img${ssrRenderAttr("src", _imports_1)} data-v-c4535ae6>`);
          }
          _push(`<!--]-->`);
        } else {
          _push(`<img src="https://hz-oss.chatdzq.com/file/common/static-web/d638965e-dd7b-4fe9-b03b-3f39c3342d1a.png" data-v-c4535ae6>`);
        }
        _push(`</div><div class="${ssrRenderClass([item.type == "SYSTEM" ? "blue" : "", "name"])}" style="${ssrRenderStyle({ "background-color": item.type == "USER" ? styleSetup.value.dialogueColor : "#fff" })}" data-v-c4535ae6>`);
        if (_ctx.$isEmpty(item.content)) {
          ...
          if (item.chatType == "VIDEO") {
            _push(`<video width="658" height="444" controls${ssrRenderAttr("src", item.content)} data-v-c4535ae6></video>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<!--]-->`);
        ...
        if (item.type == "SYSTEM" && index == 0) {
          _push(`<!--[--><h3 data-v-c4535ae6>\u60A8\u53EF\u4EE5\u544A\u8BC9\u6211\u9700\u8981\u521B\u4F5C\u4EC0\u4E48\u5185\u5BB9\uFF1F\u6BD4\u5982\u4E0B\u9762\uFF1A</h3><!--[-->`);
          ssrRenderList(robotPromptList.value, (item2, idx) => {
            _push(`<div class="tag" data-v-c4535ae6>${ssrInterpolate(item2)}</div>`);
          });
          _push(`<!--]--><!--]-->`);
        } else {
          _push(`<!---->`);
      ...
      _push(`<!--]--><div id="bottoms" data-v-c4535ae6></div></div><div class="preview-content-bottom" data-v-c4535ae6>`);
...
const shareDialogue = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-c4535ae6"]]);
...
//# sourceMappingURL=_id_-92a3fe7f.mjs.map
