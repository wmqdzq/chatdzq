...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: emits }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ id: "main-header" }, _attrs))} data-v-283ddc9c><div class="watermark" data-v-283ddc9c></div><div class="headerArea" data-v-283ddc9c><div class="header-top" style="${ssrRenderStyle({ "width": "100%" })}" data-v-283ddc9c>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="header-logo" data-v-283ddc9c${_scopeId}><img class="header-logo1"${ssrRenderAttr("src", unref(routing).configuration.homeLogo)} data-v-283ddc9c${_scopeId}></div>`);
          } else {
            return [
      ...
      if (isAdShow.value !== null) {
        _push(`<div class="menu-list" data-v-283ddc9c>`);
        if (isAdShow.value) {
          _push(`<ul class="menu-list-menu" data-v-283ddc9c><!--[-->`);
          ssrRenderList(pageList.value, (item, i) => {
            _push(`<!--[-->`);
            if (item.isShow) {
              _push(`<!--[-->`);
              if (item.url == "/app") {
                _push(`<li class="menu-list-menu-item cursor en-header-title" data-v-283ddc9c><div class="${ssrRenderClass([item.isSelect ? "active" : "", "menu-list-menu-item-content"])}" data-v-283ddc9c>${ssrInterpolate(item.title)} `);
                if (unref(locale) == "zh") {
                  _push(`<p data-v-283ddc9c>${ssrInterpolate(item.en)}</p>`);
                } else {
                  _push(`<!---->`);
                }
                _push(`</div>`);
                if (item.isSelect && item.url != "/") {
                  _push(`<div class="menu-list-menu-item-tag" data-v-283ddc9c></div>`);
                } else {
                  _push(`<!---->`);
                }
                _push(`</li>`);
                ...
                _push(ssrRenderComponent(_component_NuxtLink, {
                  ...
                  default: withCtx((_, _push2, _parent2, _scopeId) => {
                    if (_push2) {
                      _push2(`<li class="menu-list-menu-item en-header-title" data-v-283ddc9c${_scopeId}><div class="${ssrRenderClass([item.isSelect ? "active" : "", "menu-list-menu-item-content"])}" data-v-283ddc9c${_scopeId}>${ssrInterpolate(item.title)} `);
                      if (unref(locale) == "zh") {
                        _push2(`<p data-v-283ddc9c${_scopeId}>${ssrInterpolate(item.en)}</p>`);
                      } else {
                        _push2(`<!---->`);
                      }
                      _push2(`</div>`);
                      if (item.isSelect && item.url != "/") {
                        _push2(`<div class="menu-list-menu-item-tag" data-v-283ddc9c${_scopeId}></div>`);
                      } else {
                        _push2(`<!---->`);
                      }
                      _push2(`</li>`);
          ...
          _push(`<!--]--><li class="menu-list-menu-item en-header-title" data-v-283ddc9c>`);
            ...
            content: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(ssrRenderComponent(_component_NuxtLink, { to: "/about" }, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<div class="menu-list-menu-item-content popContent" data-v-283ddc9c${_scopeId2}>${ssrInterpolate(_ctx.$t("heder.\u5173\u4E8E\u6211\u4EEC"))}</div>`);
                    } else {
                      return [
                ...
                _push2(ssrRenderComponent(_component_NuxtLink, { to: "/news" }, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<div class="menu-list-menu-item-content popContent" data-v-283ddc9c${_scopeId2}>${ssrInterpolate(_ctx.$t("heder.\u65B0\u95FB\u8D44\u8BAF"))}</div>`);
                    } else {
                      return [
                ...
                _push2(ssrRenderComponent(_component_NuxtLink, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      if (unref(locale) == "zh") {
                        _push3(`<p data-v-283ddc9c${_scopeId2}>About us</p>`);
                      } else {
                        _push3(`<!---->`);
                      }
                    } else {
          ...
          _push(`<div class="${ssrRenderClass([unref(router).currentRoute._value.path == "/" ? "model" : "", "teamHead"])}" data-v-283ddc9c>`);
            ...
            ssrRenderList(unref(routing).topNavList, (item) => {
              ...
              if (item.viewResDtoList && item.viewResDtoList.length > 0) {
                _push(ssrRenderComponent(_component_Dropdown, {
                  ...
                  default: withCtx((_, _push2, _parent2, _scopeId) => {
                    if (_push2) {
                      _push2(`<p class="pointer" data-v-283ddc9c${_scopeId}>${ssrInterpolate(item.name)} <img class="drop-down"${ssrRenderAttr("src", _imports_7)} alt="" data-v-283ddc9c${_scopeId}></p>`);
                    } else {
                      return [
                ...
                if (item.businessType == "BIG_MODEL_SELECT") {
                  ...
                  if (unref(router).currentRoute._value.path != "/") {
                    _push(`<a data-v-283ddc9c>${ssrInterpolate(item.name)}</a>`);
                  } else {
                    _push(`<!---->`);
                  }
                  _push(`<!--]-->`);
      ...
      if (!_ctx.$isEmpty(unref(authtoken))) {
        _push(`<div class="header-right" data-v-283ddc9c><div class="individual cursor" data-v-283ddc9c>\u4E2A\u4EBA\u5DE5\u4F5C\u53F0</div>`);
        if (unref(routing).clientType == "TEAM") {
          _push(`<!--[-->`);
          if (menberShow.value) {
            _push(`<div class="header-right-serve cursor en-header-title" data-v-283ddc9c>${ssrInterpolate(_ctx.$t("heder.\u5F00\u901A\u670D\u52A1"))} `);
            if (unref(locale) == "zh") {
              _push(`<!--[--><br data-v-283ddc9c> Activate Services <!--]-->`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div>`);
          ...
          _push(`<div class="header-right-point" data-v-283ddc9c><div class="header-right-point-logo" data-v-283ddc9c></div><div data-v-283ddc9c>${ssrInterpolate(unref(routing).electric)}</div></div><!--]-->`);
        } else {
          _push(`<!--[--><div class="header-right-serve cursor en-header-title" data-v-283ddc9c>${ssrInterpolate(_ctx.$t("heder.\u5F00\u901A\u670D\u52A1"))} `);
          if (unref(locale) == "zh") {
            _push(`<!--[--><br data-v-283ddc9c> Activate Services <!--]-->`);
          ...
          _push(ssrRenderComponent(_component_NuxtLink, { to: "/equity" }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="header-right-point" data-v-283ddc9c${_scopeId}><div class="header-right-point-logo" data-v-283ddc9c${_scopeId}></div><div data-v-283ddc9c${_scopeId}>${ssrInterpolate(unref(routing).electric)}</div></div>`);
              } else {
                return [
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_Dropdown, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="header-right-user" data-v-283ddc9c${_scopeId2}>`);
                    if (unref(routing).teanList.length > 0) {
                      _push3(`<!--[-->`);
                      if (unref(routing).currentTean) {
                        _push3(`<!--[-->`);
                        if (unref(routing).currentTean.personFlag) {
                          _push3(`<!--[-->`);
                          if (!unref(routing).userLogo) {
                            _push3(`<img${ssrRenderAttr("src", _imports_1$1)} data-v-283ddc9c${_scopeId2}>`);
                          } else {
                            _push3(`<img${ssrRenderAttr("src", unref(routing).userLogo)} data-v-283ddc9c${_scopeId2}>`);
                          }
                          _push3(`<!--]-->`);
                        } else {
                          _push3(`<img${ssrRenderAttr("src", unref(routing).currentTean.headPortrait)} data-v-283ddc9c${_scopeId2}>`);
                        }
                        _push3(`<!--]-->`);
                      } else {
                        _push3(`<!---->`);
        ...
        _push(`<div class="header-right" data-v-283ddc9c>`);
        _push(ssrRenderComponent(_component_Button, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              if (unref(locale) == "zh") {
                _push2(`<!--[--><br data-v-283ddc9c${_scopeId}>Sign Up &amp; Log In <!--]-->`);
              } else {
                _push2(`<!---->`);
              }
            } else {
      ...
      if (isAdShow.value && otherSelectChildren.value && otherSelectChildren.value.length > 0) {
        _push(`<div class="headerNavArea" data-v-283ddc9c><div class="icon" data-v-283ddc9c>`);
...
const Header = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-283ddc9c"]]);

export { Header as H };
//# sourceMappingURL=index-87254bea.mjs.map
