    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_cModal, {
        ...
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="modalTitle" data-v-95c5f75a${_scopeId}>\u8BAD\u7EC3</div>`);
          } else {
            return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="content" data-v-95c5f75a${_scopeId}>`);
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(ssrRenderComponent(_component_FormItem, { label: "\u5BFC\u5165\u6587\u4EF6\u5939" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "column" })}" data-v-95c5f75a${_scopeId3}>`);
                    ...
                    _push3(ssrRenderComponent(_component_FormItem, { label: "\u5904\u7406\u65B9\u5F0F" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div data-v-95c5f75a${_scopeId3}>\u7CFB\u7EDF\u9ED8\u8BA4\u5206\u5272\u548C\u9884\u5904\u7406\u89C4\u5219</div>`);
                        } else {
                          return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/ai/modal/train.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const train = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-95c5f75a"]]);

export { train as default };
//# sourceMappingURL=train-a37bc917.mjs.map
