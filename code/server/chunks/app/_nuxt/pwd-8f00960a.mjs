    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_cModal, mergeProps({
        ...
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="modal-title" data-v-4016f339${_scopeId}>\u8BBE\u7F6E\u767B\u5F55\u5BC6\u7801</div>`);
          } else {
            return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="item" data-v-4016f339${_scopeId}><div class="item-input" data-v-4016f339${_scopeId}><input${ssrRenderAttr("value", pwdParams.value.pw2)} autocomplete="new-password" type="password" placeholder="\u8BF7\u8F93\u5165\u65B0\u5BC6\u7801" data-v-4016f339${_scopeId}></div></div><div class="item" data-v-4016f339${_scopeId}><div class="item-input" data-v-4016f339${_scopeId}><input${ssrRenderAttr("value", pwdParams.value.pw3)} autocomplete="new-password" type="password" maxlength="20" placeholder="\u8BF7\u8F93\u51656~20\u4F4D\u5BC6\u7801" data-v-4016f339${_scopeId}></div></div>`);
          } else {
            return [
...
const pwd = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4016f339"]]);

export { pwd as default };
//# sourceMappingURL=pwd-8f00960a.mjs.map
