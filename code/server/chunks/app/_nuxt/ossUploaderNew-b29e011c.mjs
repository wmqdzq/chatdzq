...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }, _attrs))} data-v-911f30c0>`);
  if ($props.modeType == "img") {
    _push(`<div class="cImage" data-v-911f30c0>`);
    if ($props.url) {
      _push(`<!--[-->`);
      ...
      _push(`<div class="deleteImg" data-v-911f30c0><img${ssrRenderAttr("src", _imports_0)} style="${ssrRenderStyle({ "width": "20px", "height": "20px" })}" data-v-911f30c0></div><!--]-->`);
    } else {
      _push(`<!--[-->`);
      ...
      _push(`<div class="cImage-img" data-v-911f30c0><img${ssrRenderAttr("src", _imports_1)} data-v-911f30c0><div class="cImage-img-name" data-v-911f30c0>\u4E0A\u4F20${ssrInterpolate($props.text ? "\u7B80\u5386" : "\u56FE\u7247")}</div><div class="cImage-upload" data-v-911f30c0><input class="upload-input" type="file"${ssrIncludeBooleanAttr($props.multiple) ? " multiple" : ""} data-v-911f30c0></div></div><!--]-->`);
    }
    _push(`</div>`);
  } else if ($props.modeType == "custom") {
    _push(`<div class="upload-area" data-v-911f30c0><div class="upload-btn" data-v-911f30c0><img${ssrRenderAttr("src", _imports_1)} data-v-911f30c0><div data-v-911f30c0>\u9009\u62E9\u6587\u4EF6\u4E0A\u4F20</div></div><input class="upload-input" type="file"${ssrIncludeBooleanAttr($props.multiple) ? " multiple" : ""} data-v-911f30c0></div>`);
  } else if ($props.modeType == "icon") {
    _push(`<div class="upload-icon" data-v-911f30c0><div class="upload-btn" style="${ssrRenderStyle({ "width": "28px", "height": "28px" })}" data-v-911f30c0><img${ssrRenderAttr("src", _imports_2)} data-v-911f30c0></div><input class="upload-input" style="${ssrRenderStyle({ "width": "32px", "height": "32px", "overflow": "hidden" })}" type="file"${ssrIncludeBooleanAttr($props.multiple) ? " multiple" : ""} data-v-911f30c0></div>`);
  } else if ($props.modeType == "file") {
    _push(`<div class="uploadFiles" data-v-911f30c0>`);
    ssrRenderSlot(_ctx.$slots, "content", {}, null, _push, _parent);
    _push(`<input class="upload-input" type="file"${ssrIncludeBooleanAttr($props.multiple) ? " multiple" : ""} data-v-911f30c0></div>`);
  } else if ($props.modeType == "freedom") {
    _push(`<div class="freedom" data-v-911f30c0>`);
    ssrRenderSlot(_ctx.$slots, "content", {}, null, _push, _parent);
    _push(`<input class="upload-input"${ssrRenderAttr("title", $props.inputTitle)} type="file"${ssrIncludeBooleanAttr($props.multiple) ? " multiple" : ""} data-v-911f30c0></div>`);
  } else if ($props.modeType == "optional") {
    _push(`<div class="uploadFiles-optional" data-v-911f30c0>`);
    _push(ssrRenderComponent(_component_Spin, {
      fix: "",
      show: $setup.loading
    }, null, _parent));
    if (!$props.url) {
      _push(`<!--[-->`);
      ssrRenderSlot(_ctx.$slots, "content", {}, null, _push, _parent);
      _push(`<input class="upload-input" type="file"${ssrIncludeBooleanAttr($props.multiple) ? " multiple" : ""} data-v-911f30c0><!--]-->`);
    } else {
      _push(`<!--[-->`);
      _push(ssrRenderComponent(_component_Image, {
        preview: true,
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_Dropdown, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="upload" data-v-911f30c0${_scopeId2}><div data-v-911f30c0${_scopeId2}>+</div><div data-v-911f30c0${_scopeId2}>\u4E0A\u4F20\u56FE\u7247</div></div>`);
                } else {
                  return [
    ...
    _push(`<div class="uploadFiles" data-v-911f30c0><img${ssrRenderAttr("src", _imports_1)} data-v-911f30c0><p data-v-911f30c0>\u5C06\u6587\u4EF6\u62D6\u5230\u6B64\u5904\uFF0C\u6216<span data-v-911f30c0>\u70B9\u51FB\u4E0A\u4F20</span></p><input class="upload-input" type="file"${ssrIncludeBooleanAttr($props.multiple) ? " multiple" : ""} data-v-911f30c0></div>`);
  }
  _push(ssrRenderComponent(_component_ClientOnly, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<input class="fileInput" type="file"${ssrIncludeBooleanAttr($props.multiple) ? " multiple" : ""} data-v-911f30c0${_scopeId}>`);
      } else {
        return [
          createVNode("input", {
            class: "fileInput",
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-911f30c0"]]);

export { __nuxt_component_0 as _ };
//# sourceMappingURL=ossUploaderNew-b29e011c.mjs.map
