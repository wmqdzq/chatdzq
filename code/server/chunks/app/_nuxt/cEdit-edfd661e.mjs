...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: emits }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "cEdit" }, _attrs))} data-v-585ff0e2>`);
      if (pageState.value) {
        _push(`<div${ssrRenderAttr("id", idStr.value)} class="cEdit-content" data-v-585ff0e2></div>`);
      } else {
        _push(`<div class="incompatible" data-v-585ff0e2><div class="incompatible-top" data-v-585ff0e2>\u6D4F\u89C8\u5668\u7248\u672C\u8FC7\u4F4E\uFF0C\u8BF7\u66F4\u65B0\u7248\u672C</div><div class="incompatible-content" data-v-585ff0e2>${ssrInterpolate(props.content)}</div></div>`);
      }
      _push(ssrRenderComponent(_component_Modal, {
        ...
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="modalHeader" data-v-585ff0e2${_scopeId}><!--[-->`);
            ssrRenderList(modalHeaderList.value, (item) => {
              _push2(`<!--[-->`);
              if (item.type == modalType.value) {
                _push2(`<div class="modalHeader-item" data-v-585ff0e2${_scopeId}><img${ssrRenderAttr("src", item.img)} class="item-img" data-v-585ff0e2${_scopeId}></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<!--]-->`);
            });
            _push2(`<!--]--><div class="modalHeader-item" data-v-585ff0e2${_scopeId}><img${ssrRenderAttr("src", _imports_8)} class="pointer refresh" data-v-585ff0e2${_scopeId}><div class="pointer" data-v-585ff0e2${_scopeId}>\u91CD\u65B0\u751F\u6210</div></div></div>`);
          } else {
            return [
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="modalFooter" data-v-585ff0e2${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Button, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<img${ssrRenderAttr("src", _imports_9)} data-v-585ff0e2${_scopeId2}><div data-v-585ff0e2${_scopeId2}>\u63D2\u5165</div>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_Button, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<img${ssrRenderAttr("src", _imports_10)} data-v-585ff0e2${_scopeId2}><div data-v-585ff0e2${_scopeId2}>\u66FF\u6362</div>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_Button, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<img${ssrRenderAttr("src", _imports_11)} data-v-585ff0e2${_scopeId2}><div data-v-585ff0e2${_scopeId2}>\u590D\u5236</div>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div${ssrRenderAttrs(mergeProps({ class: "modal-content" }, ssrGetDirectiveProps(_ctx, _directive_load, modalContentLoading.value)))} data-v-585ff0e2${_scopeId}>`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-585ff0e2"]]);

export { __nuxt_component_1 as _, _imports_8 as a };
//# sourceMappingURL=cEdit-edfd661e.mjs.map
