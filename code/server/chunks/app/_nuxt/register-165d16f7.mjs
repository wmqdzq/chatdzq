...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-aa82669d><div class="login-main" data-v-aa82669d>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="logo" data-v-aa82669d${_scopeId}><img class="login-main-img"${ssrRenderAttr("src", unref(routing).configuration.loginLogo)} data-v-aa82669d${_scopeId}></div>`);
          } else {
            return [
      ...
      _push(`<div class="login-area" data-v-aa82669d>`);
      if (active.value != 3) {
        _push(`<!--[--><div class="title-name" data-v-aa82669d>\u6CE8\u518C\u65B0\u8D26\u53F7</div><div class="form" data-v-aa82669d>`);
              ...
              _push2(ssrRenderComponent(_component_FormItem, null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<div class="code" data-v-aa82669d${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_Input, {
                      size: "large",
                      autocomplete: "new-password",
        ...
        _push(`</div><div class="name" data-v-aa82669d><div data-v-aa82669d><span data-v-aa82669d>\u5DF2\u6709\u8D26\u53F7,</span><span data-v-aa82669d>`);
        ...
        _push(`<div class="agree" data-v-aa82669d>`);
        _push(ssrRenderComponent(_component_Checkbox, {
          modelValue: single.value,
          "onUpdate:modelValue": ($event) => single.value = $event
        }, null, _parent));
        _push(`<div data-v-aa82669d>\u767B\u5F55\u6216\u6CE8\u518C\u5373\u4EE3\u8868\u540C\u610F</div><a${ssrRenderAttr("href", unref(routing).configuration.userServiceLink)} data-v-aa82669d>\u7528\u6237\u670D\u52A1\u534F\u8BAE</a><div data-v-aa82669d>\u548C</div><a${ssrRenderAttr("href", unref(routing).configuration.privacyPolicy)} data-v-aa82669d>\u9690\u79C1\u653F\u7B56</a></div><!--]-->`);
      } else {
      ...
      _push(`</div><div class="login-bottom" data-v-aa82669d><div data-v-aa82669d>\u641C\u7D22\u65E0\u9650\u53EF\u80FD\uFF01</div></div></div></div>`);
    };
  }
});
...
const register = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-aa82669d"]]);

export { register as default };
//# sourceMappingURL=register-165d16f7.mjs.map
