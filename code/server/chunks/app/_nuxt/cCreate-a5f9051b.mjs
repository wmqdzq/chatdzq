          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_Modal, {
              ...
              header: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="header" data-v-13fbc39b${_scopeId2}><div data-v-13fbc39b${_scopeId2}>\u7F16\u8F91</div><img${ssrRenderAttr("src", _imports_0)} data-v-13fbc39b${_scopeId2}></div>`);
                } else {
                  return [
              ...
              footer: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="footer" data-v-13fbc39b${_scopeId2}><div class="footer-title" data-v-13fbc39b${_scopeId2}><img${ssrRenderAttr("src", _imports_2)} data-v-13fbc39b${_scopeId2}><div class="title1" data-v-13fbc39b${_scopeId2}>\u5171\u6D88\u8017</div><div class="title2" data-v-13fbc39b${_scopeId2}>${ssrInterpolate(consumeEnergy.value)}</div><div class="title3" data-v-13fbc39b${_scopeId2}>\u7535\u91CF</div></div><div class="footer-btn" data-v-13fbc39b${_scopeId2}>`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="cCreate-content" data-v-13fbc39b${_scopeId2}>`);
                  if (!loading.value) {
                    _push3(`<!--[-->`);
                    if (infoData.value && infoData.value.code) {
                      _push3(`<!--[--><div class="content-top" data-v-13fbc39b${_scopeId2}><img${ssrRenderAttr("src", infoData.value.robotLogo)} data-v-13fbc39b${_scopeId2}><div class="top-name" data-v-13fbc39b${_scopeId2}><div class="name" data-v-13fbc39b${_scopeId2}>${ssrInterpolate(infoData.value.name)}</div><div class="remark" data-v-13fbc39b${_scopeId2}>${ssrInterpolate(infoData.value.robotRemark)}</div></div></div><div class="content-main" data-v-13fbc39b${_scopeId2}>`);
                      if (isShowExample.value) {
                        _push3(`<div class="form-item" data-v-13fbc39b${_scopeId2}><div class="form-item-title" data-v-13fbc39b${_scopeId2}><div class="example" style="${ssrRenderStyle({ "padding": "0" })}" data-v-13fbc39b${_scopeId2}>\u4E0D\u77E5\u9053\u5199\u4EC0\u4E48?</div><div class="href" data-v-13fbc39b${_scopeId2}>\u8BD5\u8BD5\u793A\u4F8B</div></div></div>`);
                      } else {
                        _push3(`<!---->`);
                      }
                      _push3(`<!--[-->`);
                      ssrRenderList(columnListData.value, (item, i) => {
                        _push3(`<div class="form-item" data-v-13fbc39b${_scopeId2}><div class="form-item-title" data-v-13fbc39b${_scopeId2}><div class="name" data-v-13fbc39b${_scopeId2}>${ssrInterpolate(item.itemName)}</div>`);
                        if (item.hadRequired) {
                          _push3(`<div class="require" data-v-13fbc39b${_scopeId2}>*</div>`);
                        } else {
                          _push3(`<!---->`);
                        }
                        if (item.formType == "EXAMINATION_COMPONENT") {
                          _push3(`<div class="addType" data-v-13fbc39b${_scopeId2}>`);
                          ...
                          _push3(`<div class="name" data-v-13fbc39b${_scopeId2}>\u6DFB\u52A0\u9898\u76EE\u7C7B\u578B</div></div>`);
                        } else {
                          _push3(`<!---->`);
                        }
                        _push3(`</div>`);
                        ...
                        _push3(ssrRenderComponent(_component_ClientOnly, null, {
                          default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                              if (item.formType == "UPLOAD_FILE") {
                                _push4(`<div class="content-upload" data-v-13fbc39b${_scopeId3}><div class="upload" data-v-13fbc39b${_scopeId3}>`);
                                _push4(ssrRenderComponent(_component_ossUploaderNew, {
                                  ...
                                  content: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                    if (_push5) {
                                      _push5(`<div class="upload-area" data-v-13fbc39b${_scopeId4}>`);
                                      if (item.value) {
                                        _push5(`<div class="area-file" data-v-13fbc39b${_scopeId4}><img${ssrRenderAttr("src", curriculumPng)} data-v-13fbc39b${_scopeId4}></div>`);
                                      } else {
                                        _push5(`<!--[-->`);
                                        ...
                                        _push5(`<div data-v-13fbc39b${_scopeId4}>\u8BF7\u4E0A\u4F20\u6587\u4EF6\uFF0C\u652F\u6301 PDF\u3001Word \u683C\u5F0F</div><!--]-->`);
                                      }
                                      _push5(`</div>`);
                                    } else {
                                      return [
                              ...
                              if (item.formType == "EXAMINATION_COMPONENT") {
                                _push4(`<div class="dataList" data-v-13fbc39b${_scopeId3}><!--[-->`);
                                ssrRenderList(dataList.value, (item2, i2) => {
                                  _push4(`<div class="dataList-item" data-v-13fbc39b${_scopeId3}>`);
                                  ...
                                  _push4(`<div class="input" data-v-13fbc39b${_scopeId3}><div class="input-title" data-v-13fbc39b${_scopeId3}>\u9898\u6570</div>`);
                                  ...
                                  _push4(`</div><div class="input" data-v-13fbc39b${_scopeId3}><div class="input-title" data-v-13fbc39b${_scopeId3}>\u603B\u5206\u503C</div>`);
                                  _push4(ssrRenderComponent(_component_InputNumber, {
                                    min: 1,
                                    modelValue: dataList.value[i2].score,
                                    "onUpdate:modelValue": ($event) => dataList.value[i2].score = $event
                                  }, null, _parent4, _scopeId3));
                                  _push4(`</div><div class="reduce" data-v-13fbc39b${_scopeId3}>`);
                          ...
                          default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                              if (item.formType == "KNOWLEDGE_COMPONENT") {
                                ...
                                _push4(`<div class="knowledge-list" data-v-13fbc39b${_scopeId3}><!--[-->`);
                                ssrRenderList(item.knowledgeList, (iten, j) => {
                                  _push4(`<div class="knowledge-item" data-v-13fbc39b${_scopeId3}><div class="item-logo" data-v-13fbc39b${_scopeId3}>`);
                                  if (iten.avatar) {
                                    _push4(`<img${ssrRenderAttr("src", iten.avatar)} data-v-13fbc39b${_scopeId3}>`);
                                  } else {
                                    _push4(`<img${ssrRenderAttr("src", _imports_1)} alt="" data-v-13fbc39b${_scopeId3}>`);
                                  }
                                  _push4(`</div><div class="item-name" data-v-13fbc39b${_scopeId3}>${ssrInterpolate(iten.name)}</div>`);
                                  _push4(ssrRenderComponent(_component_Icon, {
                                  ...
                                  createVNode("div", { class: "knowledge-list" }, [
                                    (openBlock(true), createBlock(Fragment, null, renderList(item.knowledgeList, (iten, j) => {
                                      return openBlock(), createBlock("div", { class: "knowledge-item" }, [
                                        ...
                                        createVNode("div", { class: "item-name" }, toDisplayString(iten.name), 1),
                                        createVNode(_component_Icon, {
                                          type: "md-close-circle",
                                          size: "15",
                                          onClick: ($event) => toRemoveKnow(item, j),
                    ...
                    _push3(`<div class="loading-data" data-v-13fbc39b${_scopeId2}>`);
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-13fbc39b"]]);

export { __nuxt_component_2 as _ };
//# sourceMappingURL=cCreate-a5f9051b.mjs.map
