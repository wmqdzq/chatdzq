...
import { r as recordCom, _ as _sfc_main$1 } from './recordNew-2087e423.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "layout-main" }, _attrs))} data-v-7e60ef59><div class="layout-main-right" data-v-7e60ef59><div class="layout-main-right-content chatArea" data-v-7e60ef59><div class="chatAreaNav clearfix" data-v-7e60ef59>`);
      if (!groupListState.value) {
        _push(`<div class="chatOperation" data-v-7e60ef59>`);
            ...
            if (_push2) {
              _push2(ssrRenderComponent(_component_Tooltip, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<img${ssrRenderAttr("src", _imports_0)} alt="" data-v-7e60ef59${_scopeId2}>`);
                  } else {
                    return [
                      createVNode("img", {
                        onClick: getData,
              ...
              _push2(ssrRenderComponent(_component_Tooltip, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<img${ssrRenderAttr("src", _imports_1)} alt="" data-v-7e60ef59${_scopeId2}>`);
                  } else {
                    return [
                      createVNode("img", {
                        onClick: toGetHis,
      ...
      if (groupListState.value) {
        _push(`<div class="chatGroupList" data-v-7e60ef59>`);
      ...
      _push(`</div><div class="chatContainer" data-v-7e60ef59>`);
      if (unref(proxy).$isEmpty(unref(router).currentRoute.value.query.code) && robotType.value !== "MULTIPLE_MODELS_CHAT") {
        _push(ssrRenderComponent(unref(Poptip), {
          ...
          content: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="modelConfigArea" data-v-7e60ef59${_scopeId}><h2 data-v-7e60ef59${_scopeId}>${ssrInterpolate(_ctx.$t("aiChat.\u6A21\u578B\u8BBE\u7F6E"))}</h2>`);
                  ...
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_FormItem, { class: "modelList" }, {
                      label: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="title" data-v-7e60ef59${_scopeId3}>${ssrInterpolate(_ctx.$t("aiChat.\u6A21\u578B"))}</div>`);
                        } else {
                          return [
                                      ...
                                      ssrRenderList(modelList.value, (item, index2) => {
                                        _push6(ssrRenderComponent(_component_Option, {
                                          ...
                                          default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                            if (_push7) {
                                              _push7(`<div style="${ssrRenderStyle({ "display": "flex", "align-items": "center" })}" data-v-7e60ef59${_scopeId6}>`);
                                              if (item.hotFlag) {
                                                _push7(`<img${ssrRenderAttr("src", _imports_8)} style="${ssrRenderStyle({ "height": "13px", "margin-right": "4px" })}" data-v-7e60ef59${_scopeId6}>`);
                                              } else {
                                                _push7(`<!---->`);
                                              }
                                              _push7(`<span class="${ssrRenderClass(item.hotFlag ? "hotColor" : "")}" data-v-7e60ef59${_scopeId6}>${ssrInterpolate(item.name)}</span><span class="gray" data-v-7e60ef59${_scopeId6}>(-${ssrInterpolate(item.consumeEnergy)} ${ssrInterpolate(_ctx.$t("aiChat.\u7535\u91CF"))})</span></div>`);
                                            } else {
                                              return [
                    ...
                    _push3(ssrRenderComponent(_component_FormItem, { class: "slider" }, {
                      label: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="title" data-v-7e60ef59${_scopeId3}>${ssrInterpolate(_ctx.$t("aiChat.\u751F\u6210\u591A\u6837\u6027"))}</div>`);
                        } else {
                          return [
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="slider" data-v-7e60ef59${_scopeId3}>`);
                          ...
                          _push4(`</div><div class="name clearfix" data-v-7e60ef59${_scopeId3}><div class="fl" data-v-7e60ef59${_scopeId3}>${ssrInterpolate(_ctx.$t("aiChat.\u7CBE\u51C6"))}</div><div class="fr" data-v-7e60ef59${_scopeId3}>${ssrInterpolate(_ctx.$t("aiChat.\u591A\u6837\u6027"))}</div></div>`);
                        } else {
                          return [
                    ...
                    _push3(ssrRenderComponent(_component_FormItem, null, {
                      label: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="title" data-v-7e60ef59${_scopeId3}>${ssrInterpolate(_ctx.$t("aiChat.\u6280\u80FD"))}</div>`);
                        } else {
                          return [
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="clearfix" data-v-7e60ef59${_scopeId3}><div class="fl" data-v-7e60ef59${_scopeId3}>${ssrInterpolate(_ctx.$t("aiChat.AI\u8054\u7F51\u641C\u7D22"))}</div>`);
                          ...
                          _push4(`</div><div class="clearfix" data-v-7e60ef59${_scopeId3}><div class="fl" data-v-7e60ef59${_scopeId3}>${ssrInterpolate(_ctx.$t("aiChat.AI\u7ED8\u753B"))}</div>`);
                          _push4(ssrRenderComponent(_component_Switch, {
                            class: "fr",
                    ...
                    _push3(ssrRenderComponent(_component_FormItem, null, {
                      label: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="title" style="${ssrRenderStyle({ "position": "relative" })}" data-v-7e60ef59${_scopeId3}>${ssrInterpolate(_ctx.$t("aiChat.\u667A\u80FD\u8054\u60F3"))} <div class="electric-tag" data-v-7e60ef59${_scopeId3}>-3${ssrInterpolate(_ctx.$t("aiChat.\u7535\u91CF"))}</div></div>`);
                        } else {
                          return [
                            createVNode("div", {
                              class: "title",
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="clearfix" data-v-7e60ef59${_scopeId3}><div class="fl" data-v-7e60ef59${_scopeId3}>${ssrInterpolate(_ctx.$t("aiChat.InputSuggestions3"))}</div>`);
                          _push4(ssrRenderComponent(_component_Switch, {
                            class: "fr",
                    ...
                    _push3(ssrRenderComponent(_component_FormItem, null, {
                      label: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="title" style="${ssrRenderStyle({ "position": "relative" })}" data-v-7e60ef59${_scopeId3}>${ssrInterpolate(_ctx.$t("aiChat.\u667A\u80FD\u4F53\u63A8\u8350"))} <div class="electric-tag" data-v-7e60ef59${_scopeId3}>-3${ssrInterpolate(_ctx.$t("aiChat.\u7535\u91CF"))}</div></div>`);
                        } else {
                          return [
                            createVNode("div", {
                              class: "title",
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="clearfix" data-v-7e60ef59${_scopeId3}><div class="fl" data-v-7e60ef59${_scopeId3}>${ssrInterpolate(_ctx.$t("aiChat.InputSuggestions"))}</div>`);
                          _push4(ssrRenderComponent(_component_Switch, {
                            class: "fr",
      ...
      if (robotType.value == "MULTIPLE_MODELS_CHAT") {
        _push(ssrRenderComponent(unref(Poptip), {
          ...
          content: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="multipleModelList" data-v-7e60ef59${_scopeId}><div class="list" data-v-7e60ef59${_scopeId}><!--[-->`);
              ssrRenderList(modelList.value, (item, index2) => {
                _push2(`<div class="clearfix item" data-v-7e60ef59${_scopeId}><div class="name fl" style="${ssrRenderStyle({ "align-items": "center" })}" data-v-7e60ef59${_scopeId}>`);
                if (item.hotFlag) {
                  _push2(`<img${ssrRenderAttr("src", _imports_8)} style="${ssrRenderStyle({ "height": "13px", "margin-right": "4px" })}" data-v-7e60ef59${_scopeId}>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`<span class="${ssrRenderClass(item.hotFlag ? "hotColor" : "")}" data-v-7e60ef59${_scopeId}>${ssrInterpolate(item.name)}</span><span data-v-7e60ef59${_scopeId}>(-${ssrInterpolate(item.consumeEnergy)}${ssrInterpolate(_ctx.$t("aiChat.\u7535\u91CF"))})</span></div></div>`);
              });
              _push2(`<!--]--></div><div class="i-230 mt-10" data-v-7e60ef59${_scopeId}>`);
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="selectModelList clearfix" data-v-7e60ef59${_scopeId}>`);
              if (robotInfo.value.multiModelInfoResVOS) {
                _push2(`<!--[-->`);
                ssrRenderList(robotInfo.value.multiModelInfoResVOS, (item, index2) => {
                  _push2(`<div class="item" data-v-7e60ef59${_scopeId}>${ssrInterpolate(item.name)} </div>`);
                });
                _push2(`<!--]-->`);
              } else {
                _push2(`<!---->`);
      ...
      _push(`<div class="${ssrRenderClass([[robotType.value == "MULTIPLE_MODELS_CHAT" ? "multipleModelChat" : "", shareState.value ? "shareChat" : ""], "dialogue"])}" data-v-7e60ef59>`);
        ...
        recordTop: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (_ctx.$isEmpty(chatList.value) && robotType.value !== "MULTIPLE_MODELS_CHAT") {
              _push2(`<div class="welcomeContentAreaCom" data-v-7e60ef59${_scopeId}>`);
              if (!_ctx.$isEmpty(robotInfo.value.robotLogo)) {
                _push2(`<img class="logo"${ssrRenderAttr("src", robotInfo.value.robotLogo)} alt="" data-v-7e60ef59${_scopeId}>`);
              } else {
                _push2(`<img class="logo"${ssrRenderAttr("src", _imports_1$1)} alt="" data-v-7e60ef59${_scopeId}>`);
              }
              _push2(`<h1 data-v-7e60ef59${_scopeId}>${ssrInterpolate(robotInfo.value.robotRemark)}</h1><p data-v-7e60ef59${_scopeId}>${ssrInterpolate(robotInfo.value.welcomeContent)}</p><div class="promptList" data-v-7e60ef59${_scopeId}><!--[-->`);
              ssrRenderList(promptListData.value, (item, index2) => {
                _push2(`<div class="area" data-v-7e60ef59${_scopeId}><div class="itemTitle" data-v-7e60ef59${_scopeId}><img${ssrRenderAttr("src", item.cateLogo)} alt="" data-v-7e60ef59${_scopeId}> ${ssrInterpolate(item.cateName)}</div><!--[-->`);
                ssrRenderList(item.promptList, (data, index22) => {
                  _push2(`<div class="${ssrRenderClass([item.type == "DOCUMENT_INTERPRETATION" ? "icon" : "", "item text-hide"])}" data-v-7e60ef59${_scopeId}>`);
                  if (item.type == "DOCUMENT_INTERPRETATION") {
                    _push2(`<img class="filePic"${ssrRenderAttr("src", _ctx.$loadFileImages(data.name))} alt="" data-v-7e60ef59${_scopeId}>`);
                  } else {
                    _push2(`<!---->`);
                  }
      ...
      _push(`</div>`);
      if (!shareState.value) {
        _push(`<div class="input-area" data-v-7e60ef59>`);
        _push(ssrRenderComponent(_component_Tooltip, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="icon" data-v-7e60ef59${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
                type: "md-add",
                color: "#0090F7"
              }, null, _parent2, _scopeId));
            ...
            if (_push2) {
              _push2(ssrRenderComponent(_component_Dropdown, {
                ...
                list: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="commonArea" data-v-7e60ef59${_scopeId2}><div class="commonArea-top" data-v-7e60ef59${_scopeId2}><div data-v-7e60ef59${_scopeId2}>\u5E38\u7528\u8BED</div><div class="topAdd" data-v-7e60ef59${_scopeId2}>+ \u6DFB\u52A0\u5E38\u7528\u8BED</div></div><div class="commonList" data-v-7e60ef59${_scopeId2}><!--[-->`);
                    ssrRenderList(commListData.value, (item, index2) => {
                      _push3(`<div class="item" data-v-7e60ef59${_scopeId2}><div class="title text-hide-1" data-v-7e60ef59${_scopeId2}>${item.keyWord}</div><div class="desc text-hide-1" data-v-7e60ef59${_scopeId2}>${ssrInterpolate(item.content)}</div><div class="oper" data-v-7e60ef59${_scopeId2}><div class="icon" data-v-7e60ef59${_scopeId2}><img${ssrRenderAttr("src", _imports_4)} alt="" data-v-7e60ef59${_scopeId2}></div><div class="icon" data-v-7e60ef59${_scopeId2}><img${ssrRenderAttr("src", _imports_5)} alt="" data-v-7e60ef59${_scopeId2}></div></div></div>`);
                    });
                    _push3(`<!--]--></div></div>`);
                  } else {
                    return [
      ...
      if (promptState.value) {
        _push(`<div style="${ssrRenderStyle({ "width": "480px" })}" data-v-7e60ef59></div>`);
      } else {
        _push(`<!---->`);
      }
      if (promptState.value) {
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7e60ef59"]]);

export { index as default };
//# sourceMappingURL=index-94f6defc.mjs.map
