...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "workbench" }, _attrs))} data-v-1e5f82c9><div class="workbench-nav" style="${ssrRenderStyle({ "z-index": unref(router).currentRoute.value.path == "/ai/ppt" ? "300" : "302" })}" data-v-1e5f82c9>`);
      _push(ssrRenderComponent(_component_workbenchNav, { list: routeList.value }, null, _parent));
      _push(`</div><div class="workbench-content" data-v-1e5f82c9>`);
...
const workbench = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1e5f82c9"]]);

export { workbench as default };
//# sourceMappingURL=workbench-f2d9ab14.mjs.map
